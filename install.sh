...
PACKAGES_FONTS=(
    dejavu-fonts-ttf liberation-fonts-ttf font-awesome6 google-fonts-ttf nerd-fonts noto-fonts-ttf noto-fonts-cjk noto-fonts-extra noto-fonts emoji terminus-font
)
